...
class BiliAPI {
    ...
    func fetchUserSpaceDynamics(mid: Int, offset: String? = nil) async throws -> UserSpaceDynamicPageResult {
        ...
        if let offset, !offset.isEmpty { queryItems.append(URLQueryItem(name: "offset", value: offset)) }
        ...
        guard decoded.code == 0 else { throw APIError.businessError(code: decoded.code, message: decoded.message) }
